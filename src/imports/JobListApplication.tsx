import svgPaths from "./svg-qf2eyzy4he";
...
import imgCompanyLogo1 from "figma:asset/8d87f7ad3bea28d89db305d56aba66b88baf28be.png";
import imgCompanyLogo2 from "figma:asset/ba6d6c854a1c04e31e5776ff40a1f161d3413f82.png";
import imgCompanyLogo3 from "figma:asset/7c189371b89442e93f6e69cd191b8ead33cd4e67.png";
...
function Wrapper() {
  return (
    <div className="absolute bg-white bottom-0 content-stretch flex flex-col items-center left-0 w-[393px]" data-name="Wrapper">
      <Wrapper1 />
    </div>
  );
}
...
function BookmarksSection() {
  return (
    <div className="content-stretch flex gap-[4px] items-center relative shrink-0" data-name="Bookmarks Section">
      ...
      <p className="font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal leading-[20px] relative shrink-0 text-[#111] text-[14px]">Bookmarks</p>
    </div>
  );
}
...
function Profile() {
  return (
    <div className="content-stretch flex items-center relative shrink-0 w-[361px]" data-name="Profile">
      <PhotoProfile />
      <p className="flex-[1_0_0] font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[28px] min-h-px min-w-px relative text-[18px] text-black whitespace-pre-wrap">{` Hi john Doe ✋ `}</p>
      <BookmarksSection />
    </div>
  );
}
...
function Header() {
  return (
    <div className="absolute content-stretch flex items-center left-[16px] top-[50px]" data-name="Header">
      <Profile />
    </div>
  );
}
...
function FilterOption() {
  return (
    <div className="bg-[#f97f3a] content-stretch flex items-center justify-center px-[10px] py-[4px] relative rounded-[12px] shrink-0" data-name="Filter Option">
      <div aria-hidden="true" className="absolute border border-[#dfe1e7] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <p className="font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[16px] relative shrink-0 text-[12px] text-white">Application</p>
    </div>
  );
}
...
function FilterOption1() {
  return (
    <div className="content-stretch flex items-center justify-center px-[10px] py-[4px] relative rounded-[12px] shrink-0" data-name="Filter Option">
      <div aria-hidden="true" className="absolute border border-[#dfe1e7] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#818898] text-[12px]">Interview</p>
    </div>
  );
}
...
function FilterOption2() {
  return (
    <div className="content-stretch flex items-center justify-center px-[10px] py-[4px] relative rounded-[12px] shrink-0" data-name="Filter Option">
      <div aria-hidden="true" className="absolute border border-[#dfe1e7] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#818898] text-[12px]">Hired</p>
    </div>
  );
}
...
function FilterOption3() {
  return (
    <div className="content-stretch flex items-center justify-center px-[10px] py-[4px] relative rounded-[12px] shrink-0" data-name="Filter Option">
      <div aria-hidden="true" className="absolute border border-[#dfe1e7] border-solid inset-0 pointer-events-none rounded-[12px]" />
      <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[16px] relative shrink-0 text-[#818898] text-[12px]">Rejected</p>
    </div>
  );
}
...
function FilterOptions() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[12px] items-center min-h-px min-w-px relative" data-name="Filter Options">
      <FilterOption />
      <FilterOption1 />
      <FilterOption2 />
      <FilterOption3 />
...
function FilterBar() {
  return (
    <div className="content-stretch flex h-[24px] items-center relative shrink-0 w-full" data-name="Filter Bar">
      <FilterOptions />
    </div>
  );
}
...
function SearchAndFilter1() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Search and Filter">
      <div className="h-[56px] relative rounded-[12px] shrink-0 w-full" data-name="Search Bar">
...
function SearchAndFilter() {
  return (
    <div className="content-stretch flex flex-col items-start relative shrink-0 w-full" data-name="Search and Filter">
      <SearchAndFilter1 />
    </div>
  );
}

function ApplicationSection1() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Application Section">
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Application Icon">
        <div className="absolute inset-[4.17%_8.33%_12.5%_8.33%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
            <path d={svgPaths.pe309e40} fill="var(--fill-0, #F97F3A)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#f97f3a] text-[14px]">My Application</p>
    </div>
  );
}
...
function ApplicationSection() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Application Section">
      <ApplicationSection1 />
    </div>
  );
}

function ApplicationSection3() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0" data-name="Application Section">
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Application Icon">
        <div className="absolute inset-[4.17%_8.33%_12.5%_8.33%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
            <path d={svgPaths.pe309e40} fill="var(--fill-0, #A4ACB9)" id="Vector" />
          </svg>
        </div>
      </div>
      <p className="font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium leading-[20px] relative shrink-0 text-[#a4acb9] text-[14px]">My Auction</p>
    </div>
  );
}

function ApplicationSection2() {
  return (
    <div className="content-stretch flex items-center relative shrink-0" data-name="Application Section">
      <ApplicationSection3 />
    </div>
...
function Frame1() {
  return (
    <div className="content-stretch flex gap-[17px] items-start relative shrink-0">
      <ApplicationSection />
      <ApplicationSection2 />
    </div>
  );
...
function ProgressBar() {
  return (
    <div className="bg-[#dfe1e7] content-stretch flex flex-col h-[10px] items-start relative rounded-[10px] shrink-0 w-full" data-name="Progress Bar">
      <div className="bg-[#f97f3a] h-[10px] rounded-[10px] shrink-0 w-full" data-name="Match Progress" />
    </div>
  );
}
...
function JobMatch() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center min-h-px min-w-px relative" data-name="Job Match">
  ...
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-end min-h-px min-w-px relative" data-name="Salary">
      ...
      <div className="flex flex-row items-end self-stretch">
        <div className="bg-[rgba(74,222,128,0.2)] content-stretch flex h-full items-center justify-center px-[10px] py-[4px] relative rounded-[20px] shrink-0 w-[116px]" data-name="Applied">
          <div className="flex flex-col font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#3ac348] text-[12px] text-center whitespace-nowrap">
            <p className="leading-[16px]">Hired</p>
          </div>
        </div>
      </div>
    </div>
...
function CardListJobMatch() {
  return (
    <div className="bg-white relative rounded-[12px] shadow-[0px_0px_8px_0px_rgba(0,0,0,0.1)] shrink-0 w-full" data-name="Card List Job Match">
...
function JobName1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative" data-name="Job Name">
      <p className="font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[24px] min-w-full relative shrink-0 text-[#0d0d12] text-[16px] w-[min-content] whitespace-pre-wrap">Operations Manager</p>
      <CompanyName1 />
    </div>
  );
}
...
function CompanyDetail1() {
  return (
    <div className="content-stretch flex gap-[6px] items-start relative shrink-0 w-full" data-name="Company Detail">
      <div className="relative rounded-[50px] shrink-0 size-[44px]" data-name="Company Logo">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[50px] size-full" src={imgCompanyLogo1} />
      </div>
      <JobName1 />
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Bookmark Icon">
        <div className="absolute inset-[12.5%_20.83%]" data-name="Vector">
...
function ProgressBar1() {
  return (
    <div className="bg-[#dfe1e7] content-stretch flex flex-col h-[10px] items-start relative rounded-[10px] shrink-0 w-full" data-name="Progress Bar">
      <div className="bg-[#f97f3a] h-[10px] rounded-[10px] shrink-0 w-[190px]" data-name="Match Progress" />
    </div>
  );
}
...
function JobMatch1() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center min-h-px min-w-px relative" data-name="Job Match">
      <div className="flex flex-col font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#f97f3a] text-[12px] whitespace-nowrap">
        <p className="leading-[16px]">Match 90%</p>
      </div>
      <ProgressBar1 />
    </div>
  );
...
function Salary3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-end min-h-px min-w-px relative" data-name="Salary">
      <JobMatch1 />
      <div className="flex flex-row items-end self-stretch">
        <div className="bg-[rgba(240,124,8,0.2)] content-stretch flex h-full items-center justify-center px-[10px] py-[4px] relative rounded-[20px] shrink-0 w-[116px]" data-name="Applied">
          <div className="flex flex-col font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#f09308] text-[12px] text-center whitespace-nowrap">
...
function CompanyDetail2() {
  return (
    <div className="content-stretch flex gap-[6px] items-start relative shrink-0 w-full" data-name="Company Detail">
      <div className="relative rounded-[50px] shrink-0 size-[44px]" data-name="Company Logo">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[50px] size-full" src={imgCompanyLogo2} />
      </div>
      <JobName2 />
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Bookmark Icon">
        <div className="absolute inset-[12.5%_20.83%]" data-name="Vector">
...
function ProgressBar2() {
  return (
    <div className="bg-[#dfe1e7] content-stretch flex flex-col h-[10px] items-start relative rounded-[10px] shrink-0 w-full" data-name="Progress Bar">
      <div className="bg-[#f97f3a] h-[10px] rounded-[10px] shrink-0 w-[206px]" data-name="Match Progress" />
    </div>
  );
}
...
function JobMatch2() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center min-h-px min-w-px relative" data-name="Job Match">
      <div className="flex flex-col font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#f97f3a] text-[12px] whitespace-nowrap">
        <p className="leading-[16px]">Match 95%</p>
      </div>
      <ProgressBar2 />
    </div>
  );
...
function Salary5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-end min-h-px min-w-px relative" data-name="Salary">
      <JobMatch2 />
      <div className="flex flex-row items-end self-stretch">
        <div className="bg-[rgba(8,136,240,0.2)] content-stretch flex h-full items-center justify-center px-[10px] py-[4px] relative rounded-[20px] shrink-0 w-[116px]" data-name="Applied">
          <div className="flex flex-col font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#0893f0] text-[12px] text-center whitespace-nowrap">
            <p className="leading-[16px]">Interview</p>
          </div>
        </div>
      </div>
    </div>
...
function CompanyDetail3() {
  return (
    <div className="content-stretch flex gap-[6px] items-start relative shrink-0 w-full" data-name="Company Detail">
      <div className="relative rounded-[50px] shrink-0 size-[44px]" data-name="Company Logo">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[50px] size-full" src={imgCompanyLogo3} />
      </div>
      <JobName3 />
      <div className="overflow-clip relative shrink-0 size-[24px]" data-name="Bookmark Icon">
        <div className="absolute inset-[12.5%_20.83%]" data-name="Vector">
...
function ProgressBar3() {
  return (
    <div className="bg-[#dfe1e7] content-stretch flex flex-col h-[10px] items-start relative rounded-[10px] shrink-0 w-full" data-name="Progress Bar">
      <div className="bg-[#f97f3a] h-[10px] rounded-[10px] shrink-0 w-[178px]" data-name="Match Progress" />
    </div>
  );
}
...
function JobMatch3() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center min-h-px min-w-px relative" data-name="Job Match">
      <div className="flex flex-col font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#f97f3a] text-[12px] whitespace-nowrap">
        <p className="leading-[16px]">Match 70%</p>
      </div>
      <ProgressBar3 />
    </div>
  );
...
function JobName4() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative" data-name="Job Name">
      <p className="font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[24px] min-w-full relative shrink-0 text-[#0d0d12] text-[16px] w-[min-content] whitespace-pre-wrap">Mining Nikel Manager</p>
      <CompanyName4 />
    </div>
  );
}

function CompanyDetail4() {
  return (
    <div className="content-stretch flex gap-[6px] items-start relative shrink-0 w-full" data-name="Company Detail">
      <div className="relative rounded-[50px] shrink-0 size-[44px]" data-name="Company Logo">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[50px] size-full" src={imgCompanyLogo3} />
...
function GeneralJobInformation4() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-full" data-name="General Job Information">
      <WorkType4 />
      <Location4 />
...
function GeneralInformationJob4() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0" data-name="General Information Job">
      <GeneralJobInformation4 />
      <Experience4 />
      <Salary8 />
    </div>
  );
...
function Salary9() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-end min-h-px min-w-px relative" data-name="Salary">
      <JobMatch4 />
      <div className="flex flex-row items-end self-stretch">
        <div className="bg-[rgba(0,199,190,0.2)] content-stretch flex h-full items-center justify-center px-[10px] py-[4px] relative rounded-[20px] shrink-0 w-[116px]" data-name="Applied">
          <div className="flex flex-col font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#00c7be] text-[12px] text-center whitespace-nowrap">
            <p className="leading-[16px]">Test Assigned</p>
          </div>
        </div>
      </div>
    </div>
...
function JobName5() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start min-h-px min-w-px relative" data-name="Job Name">
      <p className="font-['Plus_Jakarta_Sans:SemiBold',sans-serif] font-semibold leading-[24px] min-w-full relative shrink-0 text-[#0d0d12] text-[16px] w-[min-content] whitespace-pre-wrap">Mining Gold Manager</p>
      <CompanyName5 />
    </div>
  );
}

function CompanyDetail5() {
  return (
    <div className="content-stretch flex gap-[6px] items-start relative shrink-0 w-full" data-name="Company Detail">
      <div className="relative rounded-[50px] shrink-0 size-[44px]" data-name="Company Logo">
        <img alt="" className="absolute inset-0 max-w-none object-cover pointer-events-none rounded-[50px] size-full" src={imgCompanyLogo3} />
...
function GeneralJobInformation5() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-full" data-name="General Job Information">
      <WorkType5 />
      <Location5 />
...
function GeneralInformationJob5() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0" data-name="General Information Job">
      <GeneralJobInformation5 />
      <Experience5 />
      <Salary10 />
    </div>
  );
...
function Salary11() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-end min-h-px min-w-px relative" data-name="Salary">
      <JobMatch5 />
      <div className="flex flex-row items-end self-stretch">
        <div className="bg-[rgba(109,0,199,0.2)] content-stretch flex h-full items-center justify-center px-[10px] py-[4px] relative rounded-[20px] shrink-0 w-[116px]" data-name="Applied">
          <div className="flex flex-col font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#6400c7] text-[12px] text-center whitespace-nowrap">
            <p className="leading-[16px]">Test Submited</p>
          </div>
        </div>
      </div>
    </div>
...
function GeneralJobInformation6() {
  return (
    <div className="content-stretch flex gap-[10px] items-center relative shrink-0 w-full" data-name="General Job Information">
      <WorkType6 />
      <Location6 />
...
function GeneralInformationJob6() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0" data-name="General Information Job">
      <GeneralJobInformation6 />
      <Experience6 />
      <Salary12 />
    </div>
  );
...
function JobDetail13() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-start relative shrink-0 w-full" data-name="Job Detail">
      <CompanyDetail6 />
      <GeneralInformationJob6 />
    </div>
  );
}
...
function ProgressBar6() {
  return (
    <div className="bg-[#dfe1e7] content-stretch flex flex-col h-[10px] items-start relative rounded-[10px] shrink-0 w-full" data-name="Progress Bar">
      <div className="bg-[#f97f3a] h-[10px] rounded-[10px] shrink-0 w-[130px]" data-name="Match Progress" />
    </div>
  );
}
...
function JobMatch6() {
  return (
    <div className="content-stretch flex flex-[1_0_0] flex-col gap-[4px] items-start justify-center min-h-px min-w-px relative" data-name="Job Match">
      <div className="flex flex-col font-['Plus_Jakarta_Sans:Regular',sans-serif] font-normal justify-center leading-[0] relative shrink-0 text-[#f97f3a] text-[12px] whitespace-nowrap">
        <p className="leading-[16px]">Match 60%</p>
      </div>
      <ProgressBar6 />
    </div>
  );
...
function Salary13() {
  return (
    <div className="content-stretch flex flex-[1_0_0] gap-[10px] items-end min-h-px min-w-px relative" data-name="Salary">
      <JobMatch6 />
      <div className="flex flex-row items-end self-stretch">
        <div className="bg-[rgba(215,62,61,0.2)] content-stretch flex h-full items-center justify-center px-[10px] py-[4px] relative rounded-[20px] shrink-0" data-name="Applied">
          <div className="flex flex-col font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[#d73e3d] text-[12px] text-center whitespace-nowrap">
            <p className="leading-[16px]">Failed Screening</p>
          </div>
        </div>
      </div>
    </div>
...
function JobCards() {
  return (
    <div className="content-stretch flex flex-col gap-[12px] items-start relative shrink-0 w-full" data-name="Job Cards">
      <CardListJobMatch />
      <CardListJobMatch1 />
      <CardListJobMatch2 />
      <CardListJobMatch3 />
...
function JobList() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[17px] items-start left-[16px] top-[116px] w-[361px]" data-name="Job List">
      <SearchAndFilter />
      <Frame1 />
      <JobCards />
    </div>
...
function Frame() {
  return (
    <div className="content-stretch flex items-center relative rounded-[40px] shrink-0">
      <div className="relative rounded-[40px] shrink-0 size-[32px]" data-name="briefcase-4-fill">
        <div className="absolute inset-[4.17%_8.33%_12.5%_8.33%]" data-name="Vector">
          <svg className="absolute block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 26.6667 26.6667">
            <path d={svgPaths.p264d0cf2} fill="var(--fill-0, #F97F3A)" id="Vector" />
          </svg>
        </div>
      </div>
    </div>
...
export default function JobListApplication() {
  return (
    <div className="bg-white overflow-clip relative rounded-[24px] size-full" data-name="Job List Application">
      ...
      <Header />
      <JobList />
      <div className="-translate-x-1/2 absolute bg-[#f97f3a] bottom-[calc(8.33%+4.33px)] content-stretch flex gap-[8px] items-center justify-center left-[calc(50%-0.5px)] pl-[26px] pr-[16px] py-[8px] rounded-[12px] shadow-[0px_4px_10px_0px_rgba(255,132,39,0.3)] w-[100px]" data-name="Button">
        <div className="flex flex-col font-['Plus_Jakarta_Sans:Medium',sans-serif] font-medium justify-center leading-[0] relative shrink-0 text-[16px] text-center text-white whitespace-nowrap">
          <p className="leading-[26px]">Filter</p>
        </div>
        <div className="overflow-clip relative shadow-[0px_1px_1px_0px_#b15b2a] shrink-0 size-[20px]" data-name="filter">
          <div className="absolute inset-[20.83%_20.13%]" data-name="Vector">
            <div className="absolute inset-[-6.43%_-6.28%]">
              <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 13.4484 13.1667">
                <path d={svgPaths.p2890a118} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeLinejoin="round" strokeWidth="1.5" />
              </svg>
            </div>
          </div>
        </div>
